  ...
  return (
    <>
      <h3 className="pt-md-3 text-start">
        <strong>
          <u>Le projet et son fonctionnement</u>
        </strong>
      </h3>
      ...
      <div className="col m-md-1">
        <p className="row container lead text-start vh-50 p-5">
          <ul className="col-xl-6  pb-3">
            <strong>
              <u>Notre mission en tant qu’entreprise à but d’emploi :</u>
            </strong>
            <br />
            <br />
            <span className="text-muted">
              ...
              &nbsp;en CDI manquants sur le territoire et adaptés aux personnes
              privées durablement d’emploi habitantes du territoire, qu’elle
              embauche sur proposition du &nbsp;
              <u>
          ...
          <ul className="col-xs-12 col-xl-5 ms-xs-0 ms-md-5 mt-sm-5 mt-md-0 pb-3">
            <strong>
              <u>Notre raison d’être :</u>
            </strong>
            <br />
            <br />
            <span className="text-muted">
              Nos emplois rendent leur dignité à des personnes privées d’emploi
              à travers des activités utiles au territoire du Teil et
            ...
            <span className="text-muted">
              ...
              <div className="row">
                <div className="col-xs-12 col-xl-5">
                  ...
                  <strong>
                    &nbsp; <u>subventionnée</u> pour couvrir partiellement leurs
                    charges liées à la production de nombreux&nbsp;
                    <u>emplois supplémentaires</u>
                  </strong>
                  .
                </div>
                <div className="col-xs-12 col-xl-7">
                  Par ailleurs, une EBE peut recourir aux financements de droit
                  commun notamment en phase d’amorçage : fonds propres,
                  investissements, trésorerie…
                  <br />
                  <br />
                  Une EBE est une structure de l’économie sociale et solidaire à
                  but non lucratif :
                  <strong>
          ...
          <div className="row mt-5">
            ...
            <div className="col-12 col-md-6">
              ...
              <li className="text-muted">
                Les partenaires de l’EBE (personnes physiques ou morales <br />
                qui par leur action soutiennent l’association dans la durée)
              </li>
            </div>

            <div className="col-12 col-md-6 mt-5">
              <strong>Composition du conseil d'administration :</strong>
              <br />
              <li className="text-muted">Frédéric Hoyiez – Président</li>
              <li className="text-muted">Anne Samiez – Secrétaire</li>
              <li className="text-muted">Jérôme Clavert – trésorier</li>
              <li className="text-muted">Olivier Peverelli</li>
              <li className="text-muted">Laurent Consigny</li>
            </div>
          </div>
        </p>
      </div>
